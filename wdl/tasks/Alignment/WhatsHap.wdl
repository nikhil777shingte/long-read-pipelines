...
task HaploTagBam {
    ...
    parameter_meta {
        to_tag_bam: "BAM to be haplotagged"
    ...
    command <<<
        ...
        mv ~{to_tag_bam} ~{prefix}.bam
        mv ~{to_tag_bai} ~{prefix}.bam.bai
    ...
    RuntimeAttr default_attr = object {
        ...
        preemptible_tries:  3,
        max_retries:        0,
        docker:             "us.gcr.io/broad-dsp-lrma/lr-whatshap:1.7"
    }
...
task Phase {
    ...
    parameter_meta {
        ...
        bam: "BAM used for genrating the unphased VCF."
    }
    ...
    command <<<
        ...
        mv ~{bam} ~{bam_prefix}.bam
        mv ~{bai} ~{bam_prefix}.bam.bai
