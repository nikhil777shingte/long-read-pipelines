...
task Crispy {
    ...
    command <<<
        ...
        gunzip -c $fastq_file > /cromwell_root/$filename_actual.fq
        mv /cromwell_root/$filename_actual.fq /cromwell_root/$filename_actual.fastq
...
def get_parameters():
    ...
    ID = 'Locus_1'
    ref_seq = str.upper('${ref_seq}')
    seq_start = str.upper('${seq_start}')
    seq_end = str.upper('${seq_end}')
    fastq_files = '*.fastq'
